function [matrix_start, uz4, store_size] = find_closest_number_to_x_from_a_list(number_of_scans, unique_list_hdf_final, filename, isos_dir)
...
delete(strcat(isos_dir,filesep,'*.mat'))
cd(current_dir)