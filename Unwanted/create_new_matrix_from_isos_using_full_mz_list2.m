...
global O_was_present pathname ll %mass int index no_of_mz_vals_from_list_length start_point count_temp en
...
%%
count_temp = 1;
matrix_start2 = zeros(size(uz2,1),size(point_count,1),'single');
